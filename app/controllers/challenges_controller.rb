class ChallengesController < ApplicationController
  ...
  def show
    @user_challenge = current_user.user_challenges.find_by(challenge_id: @challenge.id)
  end
  ...
  def create
    ...
    respond_to do |format|
      if @challenge.save
        CreateTestFileJob.perform_later(@challenge.id)
  ...
  private
    ...
    def challenge_params
      params.require(:challenge).permit(:description, :tests)
    end
end
